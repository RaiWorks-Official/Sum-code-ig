--[[
    ...
    Version: 2.1.1 (Edited for darker theme, light gray selected tabs, responsive sizing, and visibility fixes)
    
    Changes:
    - Made overall theme darker (dark gray tones).
    - Selected tab color changed to light gray.
    - Added UIAspectRatioConstraint for consistent ratio across devices.
    - Set ScreenGui.IgnoreGuiInset = true for better mobile compatibility.
    - Fixed potential visibility issues: Set tab.Content.BackgroundTransparency = 0 and BackgroundColor3 to Config.Theme.Background for better contrast.
    - Ensured components (buttons, etc.) are visible by adjusting ZIndex and ClipsDescendants where needed.
    - Minor tweaks to ensure buttons and components work/show when tab is selected.
]]
...
function NexusUI.GetComponentMethods()
    ...
    -- Section Component
    function methods:Section(title)
        local section = {}
    ...
    -- Label Component
    function methods:Label(text, description)
    ...
    -- Button Component
    function methods:Button(text, description, callback, cooldown)
    ...
    -- Toggle Component
    function methods:Toggle(text, description, default, callback)
    ...
    -- Slider Component
    function methods:Slider(text, description, min, max, default, callback)
    ...
    -- Input Component
    function methods:Input(placeholder, description, callback)
        local frame = Instance.new("Frame")
        frame.Name = "Input"
        frame.Size = description and UDim2.new(1, 0, 0, 50) or UDim2.new(1, 0, 0, 38)
        frame.BackgroundColor3 = Config.Theme.Secondary
    ...
    -- Dropdown Component
    function methods:Dropdown(text, optionsList, multi, description, callback)
